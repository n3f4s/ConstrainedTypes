...
// TODO : faire d'autres contraintes

#define error( cond, func ) \
    func( std::string{__PRETTY_FUNCTION__}, std::string{#cond} )
...
class Numeric_Type
{
  public:
    ...
    // std::is_default_constructible< Constraint_t >::value,
    ...
    Numeric_Type& operator<<=( const Numeric_Type< T, Constraint_t >& count )
    {
        *this = inplace_op(
    ...
    constexpr Numeric_Type operator+() const { return Numeric_Type{+value_}; }
